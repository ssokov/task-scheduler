...
var RPC = struct {
	TaskService struct{ Count, Get, GetByID, Add, Update, Delete, Validate string }
...
func (TaskService) SMD() smd.ServiceInfo {
	return smd.ServiceInfo{
		Methods: map[string]smd.Service{
			"Count": {
				Description: `Count returns count Tasks according to conditions in search params.`,
				Parameters: []smd.JSONSchema{
					{
						Name:        "search",
						Optional:    true,
						Description: `TaskSearch`,
						Type:        smd.Object,
						TypeName:    "TaskSearch",
			...
			"Get": {
				Description: `Get returns а list of Tasks according to conditions in search params.`,
				Parameters: []smd.JSONSchema{
					{
						Name:        "search",
						Optional:    true,
			...
			"GetByID": {
				Description: `GetByID returns a Task by its ID.`,
				Parameters: []smd.JSONSchema{
					{
						Name:        "id",
						Description: `int64`,
			...
			"Add": {
				Description: `Add adds a Task from the query.`,
				Parameters: []smd.JSONSchema{
					{
						Name:        "task",
						Description: `Task`,
			...
			"Update": {
				Description: `Update updates the Task data identified by id from the query.`,
				Parameters: []smd.JSONSchema{
					{
						Name:     "task",
						Type:     smd.Object,
			...
			"Delete": {
				Description: `Delete deletes the Task by its ID.`,
				Parameters: []smd.JSONSchema{
					{
						Name:        "id",
						Description: `int64`,
			...
			"Validate": {
				Description: `Validate verifies that Task data is valid.`,
				Parameters: []smd.JSONSchema{
					{
						Name:        "task",
						Description: `Task`,
...
func (s TaskService) Invoke(ctx context.Context, method string, params json.RawMessage) zenrpc.Response {
	...
	switch method {
	case RPC.TaskService.Count:
		var args = struct {
			Search *TaskSearch `json:"search"`
		}{}
	...
	case RPC.TaskService.Add:
		var args = struct {
			Task Task `json:"task"`
		}{}

		if zenrpc.IsArray(params) {
			if params, err = zenrpc.ConvertToObject([]string{"task"}, params); err != nil {
				return zenrpc.NewResponseError(nil, zenrpc.InvalidParams, "", err.Error())
			}
		}
		...
		resp.Set(s.Add(ctx, args.Task))

	case RPC.TaskService.Update:
		var args = struct {
			Task Task `json:"task"`
		}{}
		...
		resp.Set(s.Update(ctx, args.Task))

	case RPC.TaskService.Delete:
		var args = struct {
			Id int64 `json:"id"`
		}{}
	...
	case RPC.TaskService.Validate:
		...
		resp.Set(s.Validate(ctx, args.Task))
