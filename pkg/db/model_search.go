...
func (aus *AppUserSearch) Apply(query *orm.Query) *orm.Query {
	if aus == nil {
		return query
	}
	if aus.ID != nil {
		aus.where(query, Tables.AppUser.Alias, Columns.AppUser.ID, aus.ID)
	}
	if aus.Login != nil {
		aus.where(query, Tables.AppUser.Alias, Columns.AppUser.Login, aus.Login)
	}
	if aus.Password != nil {
		aus.where(query, Tables.AppUser.Alias, Columns.AppUser.Password, aus.Password)
	}
	if aus.Name != nil {
		aus.where(query, Tables.AppUser.Alias, Columns.AppUser.Name, aus.Name)
	}
	if aus.Surname != nil {
		aus.where(query, Tables.AppUser.Alias, Columns.AppUser.Surname, aus.Surname)
	}
	if len(aus.IDs) > 0 {
		Filter{Columns.AppUser.ID, aus.IDs, SearchTypeArray, false}.Apply(query)
	}
	if aus.LoginILike != nil {
		Filter{Columns.AppUser.Login, *aus.LoginILike, SearchTypeILike, false}.Apply(query)
	}
	if aus.NameILike != nil {
		Filter{Columns.AppUser.Name, *aus.NameILike, SearchTypeILike, false}.Apply(query)
	}
	if aus.SurnameILike != nil {
		Filter{Columns.AppUser.Surname, *aus.SurnameILike, SearchTypeILike, false}.Apply(query)
	}
...
func (aus *AppUserSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		if aus == nil {
			return query, nil
		}
		return aus.Apply(query), nil
	}
}

type TaskFileSearch struct {
	search
...
func (tfs *TaskFileSearch) Apply(query *orm.Query) *orm.Query {
	if tfs == nil {
		return query
	}
	if tfs.TaskID != nil {
		tfs.where(query, Tables.TaskFile.Alias, Columns.TaskFile.TaskID, tfs.TaskID)
	}
	if tfs.FileID != nil {
		tfs.where(query, Tables.TaskFile.Alias, Columns.TaskFile.FileID, tfs.FileID)
	}
...
func (tfs *TaskFileSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		if tfs == nil {
			return query, nil
		}
		return tfs.Apply(query), nil
	}
}
...
func (ts *TaskSearch) Apply(query *orm.Query) *orm.Query {
	...
	if ts.IsDeadline != nil {
		ts.where(query, Tables.Task.Alias, Columns.Task.IsDeadline, ts.IsDeadline)
	}
	if ts.UserID != nil {
		ts.where(query, Tables.Task.Alias, Columns.Task.UserID, ts.UserID)
	}
	if ts.DeadLine != nil {
...
func (tss *TaskStatusSearch) Apply(query *orm.Query) *orm.Query {
	if tss == nil {
		return query
	}
	if tss.StatusID != nil {
		tss.where(query, Tables.TaskStatus.Alias, Columns.TaskStatus.StatusID, tss.StatusID)
	}
	if tss.Title != nil {
		tss.where(query, Tables.TaskStatus.Alias, Columns.TaskStatus.Title, tss.Title)
	}
	if tss.Alias != nil {
		tss.where(query, Tables.TaskStatus.Alias, Columns.TaskStatus.Alias, tss.Alias)
	}
	if len(tss.StatusIDs) > 0 {
		Filter{Columns.TaskStatus.StatusID, tss.StatusIDs, SearchTypeArray, false}.Apply(query)
	}
	if tss.NotStatusID != nil {
		Filter{Columns.TaskStatus.StatusID, *tss.NotStatusID, SearchTypeEquals, true}.Apply(query)
	}
	if tss.TitleILike != nil {
		Filter{Columns.TaskStatus.Title, *tss.TitleILike, SearchTypeILike, false}.Apply(query)
	}
...
func (tss *TaskStatusSearch) Q() applier {
	return func(query *orm.Query) (*orm.Query, error) {
		if tss == nil {
			return query, nil
		}
		return tss.Apply(query), nil
	}
}
