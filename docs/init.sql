...
---- Tasks:
INSERT INTO "task_statuses" ( "statusId", "title", "alias" ) VALUES ( 1, 'Опубликован', 'enabled' );
INSERT INTO "task_statuses" ( "statusId", "title", "alias" ) VALUES ( 2, 'Не опубликован', 'disabled' );
INSERT INTO "task_statuses" ( "statusId", "title", "alias" ) VALUES ( 3, 'Удален', 'deleted' );